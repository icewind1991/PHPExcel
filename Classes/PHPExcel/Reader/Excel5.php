...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	const XLS_Type_CHUNITS 				= 0x1001;
	const XLS_Type_CHCHART 				= 0x1002;
	const XLS_Type_CHSERIES 			= 0x1003;
	const XLS_Type_CHDATAFORMAT			= 0x1006;
	const XLS_Type_CHLINEFORMAT			= 0x1007;
	const XLS_Type_CHMARKERFORMAT		= 0x1009;
	const XLS_Type_CHAREAFORMAT			= 0x100A;
	const XLS_Type_CHPIEFORMAT			= 0x100B;
	const XLS_Type_CHATTACHEDLABEL		= 0x100C;
	const XLS_Type_CHSTRING				= 0x100D;
	const XLS_Type_CHCHARTFORMAT		= 0x1014;
	const XLS_Type_CHLEGEND				= 0x1015;
	const XLS_Type_CHSERIESLIST			= 0x1016;
	const XLS_Type_CHBAR				= 0x1017;
	const XLS_Type_CHLINE				= 0x1018;
	const XLS_Type_CHPIE				= 0x1019;
	const XLS_Type_CHAREA				= 0x101A;
	const XLS_Type_CHSCATTER			= 0x101B;
	const XLS_Type_CHCHARTLINE			= 0x101C;
	const XLS_Type_CHAXIS				= 0x101D;
	const XLS_Type_CHTICK				= 0x101E;
	const XLS_Type_CHVALUERANGE			= 0x101F;
	const XLS_Type_CHLABELRANGE			= 0x1020;
	const XLS_Type_CHAXISLINE			= 0x1021;
	const XLS_Type_CHFORMATLINK			= 0x1022;
	const XLS_Type_CHDEFAULTTEXT		= 0x1024;
	const XLS_Type_CHTEXT				= 0x1025;
	const XLS_Type_CHFONT				= 0x1026;
	const XLS_Type_CHOBJECTLINK			= 0x1027;
	const XLS_Type_CHARROW				= 0x102D;
	const XLS_Type_CHARROWHEAD			= 0x102F;
	const XLS_Type_CHFRAME				= 0x1032;
	const XLS_Type_CHBEGIN				= 0x1033;
	const XLS_Type_CHEND				= 0x1034;
	const XLS_Type_CHPLOTAREA			= 0x1035;
	const XLS_Type_CHCHARTSIZE			= 0x1036;
	const XLS_Type_CHRELPOSITION		= 0x1037;
	const XLS_Type_CHARROWRELPOS		= 0x1038;
	const XLS_Type_CHCHART3D			= 0x103A;
	const XLS_Type_CHMULTILINK			= 0x103B;
	const XLS_Type_CHPICFORMAT			= 0x103C;
	const XLS_Type_CHDROPBAR			= 0x103D;
	const XLS_Type_CHRADARLINE			= 0x103E;
	const XLS_Type_CHSURFACE			= 0x103F;
	const XLS_Type_CHRADARAREA			= 0x1040;
	const XLS_Type_CHAXESSET			= 0x1041;
	const XLS_Type_CHLEGENDENTRY		= 0x1043;
	const XLS_Type_CHPROPERTIES			= 0x1044;
	const XLS_Type_CHSERGROUP			= 0x1045;
	const XLS_Type_CHUSEDAXESSETS		= 0x1046;
	const XLS_Type_CHPIVOTREF			= 0x1048;
	const XLS_Type_CHSERPARENT			= 0x104A;
	const XLS_Type_CHSERTRENDLINE		= 0x104B;
	const XLS_Type_CHFORMAT				= 0x104E;
	const XLS_Type_CHPOS				= 0x104F;
	const XLS_Type_CHFORMATRUNS			= 0x1050;
	const XLS_Type_CHSOURCELINK 		= 0x1051;
	const XLS_Type_CHSERERRORBAR 		= 0x105B;
	const XLS_Type_CHSERIESFORMAT 		= 0x105D;
	const XLS_Type_CH3DDATAFORMAT 		= 0x105F;
	const XLS_Type_CHFONTBASE	 		= 0x1060;
	const XLS_Type_CHPIEEXT		 		= 0x1061;
	const XLS_Type_CHEXTRANGE	 		= 0x1062;
	const XLS_Type_CHDATATABLE	 		= 0x1063;
	const XLS_Type_CHPLOTGROWTH	 		= 0x1064;
	const XLS_Type_CHSERINDEX	 		= 0x1065;
	const XLS_Type_CHESCHERFORMAT 		= 0x1066;
	const XLS_Type_CHPIEEXTSETT	 		= 0x1067;
